...
Temp = 42
#
# ##code for the actual plot goes here
# 
#
#
################
...
plt.text(x=5.5, y=0.05, s="0", fontsize=fontsz, ha = "left", va = "center")#F=0
plt.text(x=5.5, y=0.18, s="1", fontsize=fontsz, ha = "left", va = "center")#F=1

plt.text(x=5.5, y=0.37, s="1", fontsize=fontsz, ha = "left", va = "center")#F'=1
plt.text(x=5.5, y=0.49, s="2", fontsize=fontsz, ha = "left", va = "center")#F'=2

plt.text(x=6.5, y=0.12, s="$F$", fontsize=fontsz, ha = "left", va = "center")#F'=1
plt.text(x=6.5, y=0.44, s="$F^{\prime}$", fontsize=fontsz, ha = "left", va = "center")#F'=2
...
# Option 1: Place image in axis coordinates (0-1)
plt.imshow(img, extent=[-5, 5, 0.05, 0.5], aspect='auto', alpha=0.7)

# Option 2: Place image in figure coordinates (absolute position)
# fig = plt.gcf()
# fig.figimage(img, xo=400, yo=300, alpha=0.7, zorder=10)
