...
isotopes = {
    "Rb85": {
        ...
        "A_e": 25.002e6,
        "B_e": 25.790e6,
        "shift": -63.4e6  # isotope shift relative to 87
    },
    "Rb87": {
        "frac": 1-abundance107,
        "I": 3/2,
...
plt.text(x=-8, y=1.09, s="Rb-D$_2$", fontsize=fontsz+2, ha = "left", va = "center") ##Metal
...
#plt.savefig(r"C:\Users\Matt\Desktop\Lvl_4\Project\voigt_Rb.pdf", bbox_inches='tight')
